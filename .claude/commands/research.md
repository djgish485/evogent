Run a background research task using Codex (GPT-5.3). Results are logged and you'll be notified when done.

Usage: /research <topic or question>

Examples:
  /research how does the Twitter API v2 rate limiting work
  /research best practices for Next.js ISR caching
...
4. Run: `bash "$REPO_ROOT/scripts/agents/spawn-research.sh" "<prompt>" "<research-id>" "codex"`
...
CRITICAL — Script argument order is: "<prompt>" "<research-id>" "<agent-type>"
  ...
  - Arg 3: "codex" (REQUIRED — always pass this)
