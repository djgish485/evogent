...
CONTRACTS = [
    ...
    ("curation_volume",
     ...
     "established-by-user", "open"),
    ("meta",
     "The interestingness rubric is a living document: reflection cycles and new in-app feedback update docs/interestingness-rubric.md (versioned), and the curator + backstop read it at runtime, so taste evolves without code changes.",
