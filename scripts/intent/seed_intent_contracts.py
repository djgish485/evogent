...
CONTRACTS = [
    ...
    ("feed_ordering",
     ...
     "established-by-user", "fixed-2026-06-10"),
    ("feed_ordering",
     "Carry-forward promotions appear in the slate shortly after the strongest new items (inserted after slot 2) with visible 'Still unread:' rationale subtitles.",
     "arrange route autoCarryForwardInsertAfter=2; browser-verified 2026-06-01 and 2026-06-07: slots 3-10 carry-forwards with rationales.",
     "GET /api/feed: displaySubtitle LIKE 'Still unread:%' on promoted carry-forward rows near top.",
     "established-by-user", "verified-2026-06-10"),
    ("feed_ordering",
